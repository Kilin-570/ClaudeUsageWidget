...
public static class L10n
{
    ...
    static readonly Dictionary<string, (string zh, string en)> Table = new()
    {
        ...
        ["menu_copy_diagnostics"] = ("複製診斷資訊", "Copy diagnostic information"),
        ...
        ["diagnostics_copied"] = ("已複製不含私人資料的診斷資訊。", "Redacted diagnostic information copied."),
        ["diagnostics_copy_failed"] = ("無法複製診斷資訊：{0}", "Could not copy diagnostics: {0}"),
